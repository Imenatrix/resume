<script lang='ts'>
	import resume from '$lib/resume/portuguese.json'
</script>
...
<div class="resume">
	<aside>
		<section>
			...
			<p>
				<b>Endereço:</b>
				{`${resume.contact.adress.street}, ${resume.contact.adress.number}, ${resume.contact.adress.district}, ${resume.contact.adress.city}, ${resume.contact.adress.state}`}
			</p>
			<p>
				<b>Telefone:</b>
